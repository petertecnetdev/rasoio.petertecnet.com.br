...
const DEFAULT_TITLE = "Rasoio | Serviços, profissionais e agendamentos";
const DEFAULT_DESCRIPTION = "Encontre estabelecimentos, profissionais e serviços, consulte disponibilidade e faça agendamentos online pela Rasoio, uma plataforma Peter Tecnet.";

const publicRoute = (path) => {
  if (path === "/") return { title: DEFAULT_TITLE, description: DEFAULT_DESCRIPTION };
  if (path === "/search") return { title: "Buscar empresas e serviços | Rasoio", description: "Pesquise estabelecimentos, profissionais, serviços e produtos disponíveis na Rasoio." };
  if (path === "/establishments") return { title: "Estabelecimentos com agendamento | Rasoio", description: "Descubra empresas e prestadores de serviços e encontre horários disponíveis para agendamento na Rasoio." };
  if (path.startsWith("/establishment/view/")) return { title: "Estabelecimento e serviços | Rasoio", description: "Veja serviços, profissionais, recursos e informações deste estabelecimento e faça seu agendamento pela Rasoio." };
  ...
  if (path === "/item/services") return { title: "Serviços com agendamento | Rasoio", description: "Encontre serviços de diferentes segmentos publicados por estabelecimentos na Rasoio." };
...
const PRIVATE_PREFIXES = ["/dashboard", "/orders", "/order/", "/user/", "/item/list/", "/item/create/", "/item/update/", "/employer/list/", "/employer/create/", "/employer/update/", "/employer/dashboard", "/employer/schedules", "/employer/orders", "/establishment/create", "/establishment/update/", "/establishment/my", "/establishment/orders/", "/establishment/item/", "/establishment/employers/", "/establishment/resources/", "/login", "/register", "/password", "/email-verify", "/logout", "/invite"];
